                        ...
                        success: function (data) {
                            ...
                            if (data.IsSuccess == "true") {
                                ...
                                $.each(data.rows, function (key, val) {
                                    ...
                                    + '<tbody>'
                                    + '<tr class="listDataTh" style="border-top: 1px solid #dddddd;width:100%; ">'
                                    + '<td  title="" class="listDataThTd nowrap" style="width:6%;position: relative;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;">'
                                    + '<a class="pager-tree" onclick="listTree(this)" href="#"></a>'
                                    + '</td>'
                                    + '<td title="" class="listDataThTd nowrap" style="width: 34%;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;">'
                                    + val.processnumber
                                    + '</td>'
                                    + '<td  title="" class="listDataThTd nowrap" style="width: 30%;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;">'
                                    + val.organizationname
                                    + '</td>'
                                    + '<td  title="" class="listDataThTd nowrap" style="text-align:center; width: 30%;overflow:hidden;white-space:nowrap;text-overflow: ellipsis;">'
                                    + val.inoroutdate
                                    + '</td>'
                                    + '</tr>'
                                    + '</tbody>'
